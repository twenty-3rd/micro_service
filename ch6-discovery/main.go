...
import (
	...
	"micro_server/ch6-discovery/config"
	"micro_server/ch6-discovery/discover"
	"micro_server/ch6-discovery/endpoint"
	"micro_server/ch6-discovery/service"
	"micro_server/ch6-discovery/transport"
	"net/http"
	"os"
	"os/signal"
	"strconv"
