...
import (
	...
	"micro_server/ch10-resiliency/string-service/config"
	"micro_server/ch10-resiliency/string-service/endpoint"
	"micro_server/ch10-resiliency/string-service/service"
	"micro_server/ch10-resiliency/string-service/transport"
